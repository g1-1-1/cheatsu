...
func getdiff(); get difficulty of the song [1] = HP  [2] = CS  [3] = OD  [4] = AR  [5] = slider speed multiplier  [6] = slider tick rate (doesnt influence slider speed, idk what this is used for)
   $temp = ""
   $j = 1
   $handle = fileopen($songfile)
